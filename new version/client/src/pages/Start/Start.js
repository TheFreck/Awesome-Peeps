			...
			return (
				<Container fluid>
					...
					{this.state.viewProfile ? (
						<Profile state={this.state} handleChange={this.handleChange} submit={this.updateProfile} />
					) : (
			...
			return (
				<div>
					{this.state.isUser ? (
						...
						<Container fluid>
							<Signup state={this.state} handleChange={this.handleChange} submit={this.signup} />
